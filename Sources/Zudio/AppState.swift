...
final class AppState: ObservableObject {
    ...
    static func instrumentPoolNames(trackIndex: Int, style: MusicStyle) -> [String] {
        ...
        case (kTrackLead1,   _):        return ["Mono Synth","Soft Brass","Pad 3 Poly","Polysynth"]
        case (kTrackLead2,   .chill):   return ["Vibraphone","Flute","Soprano Sax","Trombone"]
        case (kTrackLead2,   .ambient): return ["Vibraphone","Celesta","Glockenspiel","Grand Piano","Metal Pad","Space Voice","FX Atmosphere"]
        ...
        case (kTrackPads,    .ambient): return ["New Age Pad","Synth Strings","Halo Pad","Sweep Pad"]
        ...
        case (kTrackTexture, .ambient): return ["Bowed Glass","Choir Aahs","FX Atmosphere","Sweep Pad","Pad 3 Poly"]
    ...
    nonisolated static func instrumentPoolPrograms(trackIndex: Int, style: MusicStyle) -> [UInt8] {
        ...
        case (kTrackLead1, _):         return [81, 62, 90, 90]
        ...
        case (kTrackTexture, .ambient):return [92, 52, 99, 90]
