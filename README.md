...
[Download for macOS](https://github.com/ZUrlocker1/Zudio/releases/download/v1.02/Zudio-1.02.dmg) &nbsp; [Available for iPhone, iPad](https://apps.apple.com/us/app/zudio-music/id6762574335)

Current release: `1.02` (build 115). Universal binary — runs natively on both Apple Silicon and Intel Macs. Download the DMG disk image file, open it, and drag Zudio to your Applications folder.
